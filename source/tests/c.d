...
const(char)* source = "func main() {var a = 10; var b=20; return a + b}";
...
int main()
{
	...
	gravity_delegate_t del = gravity_delegate_t();
	del.error_callback = &report_error;

	// compile Gravity source code into bytecode
	gravity_compiler_t* compiler = gravity_compiler_create(&del);
	gravity_closure_t* closure = gravity_compiler_run(compiler, source,
